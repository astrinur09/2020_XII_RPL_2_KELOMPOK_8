    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">siapa sadja</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="{{URL::to('admin/Voting')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{URL::to('admin/table3')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>management siswa</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{URL::to('admin/table')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Management calon</p>
                </a>
              </li>
            </ul>
